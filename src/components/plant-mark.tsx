// Decorative plant illustration (fill follows the current text color). A small
// amber node on the stem occasionally emits a burst of faint expanding rings:
// the "heard" moment.
export default function PlantMark({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" aria-hidden="true" className={className}>
      ...
      <circle cx="292" cy="130" r="7" style={{ fill: "var(--amber)" }} />
    </svg>
  );
}
