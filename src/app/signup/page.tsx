  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-bg px-4">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-surface p-8">
        ...
        <p className="mt-1 text-sm text-ink2">Create your workspace.</p>
        ...
        <form action={signup} className="mt-6 flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="orgName" className="text-xs font-medium uppercase tracking-wide text-ink2">
              Organization name
            </label>
            <input
              id="orgName"
        ...
        <p className="mt-6 text-center text-sm text-ink2">
          ...
          <Link href="/login" className="text-canopy underline">
            Sign in
          </Link>
        </p>
      </div>
